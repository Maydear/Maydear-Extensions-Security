...
namespace Maydear.Extensions.Security
{
    internal class RSAUtilities
    {
        ...
        internal static AsymmetricKeyParameter GetKeyParameterFormPublicKey(string publicKey)
        {
        ...
        internal static RSAParameters GetRSAParametersFormPublicKey(string publicKey)
        {
        ...
        internal static AsymmetricKeyParameter GetPublicKeyParameterFormAsn1PublicKey(string publicKey)
        {
